...
6. **Existing `2026-05-27-power-map-integration.md` cleanup.** Sub-spec still references the discarded `queued-for-review` disposition. *(Open — landing as a plan step.)*
