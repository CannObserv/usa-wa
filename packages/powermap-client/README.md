# powermap-client
A client library for accessing power-map

## Usage
First, create a client:

```python
from powermap_client import Client
...
```python
from powermap_client.models import MyDataModel
from powermap_client.api.my_tag import get_my_data_model
from powermap_client.types import Response
...
1. Any endpoint which did not have a tag will be in `powermap_client.api.default`
