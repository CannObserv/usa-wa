...
from ...models.contact_new_row_admin_jurisdictions_entity_id_contacts_new_row_get_contact_type import (
...
def _get_kwargs(
    entity_id: str,
    *,
    contact_type: ContactNewRowAdminJurisdictionsEntityIdContactsNewRowGetContactType,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/admin/jurisdictions/{entity_id}/contacts/new-row/".format(
