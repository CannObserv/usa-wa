...
from ...models.organization_observation_request import OrganizationObservationRequest
from ...types import Response


def _get_kwargs(
    *,
    body: OrganizationObservationRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/orgs/observations",
    }
...
def sync_detailed(
    *,
    ...
    """Submit Org Observation

     Submit an organization identity observation; attach to existing org or create a new one.

    Args:
        body (OrganizationObservationRequest): Payload for POST /api/v1/orgs/observations.
