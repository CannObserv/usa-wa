...
from ...models.jurisdiction_observation_request import JurisdictionObservationRequest
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/jurisdictions/observations",
    }
...
def sync_detailed(
    *,
    ...
    Args:
        body (JurisdictionObservationRequest): Payload for POST
