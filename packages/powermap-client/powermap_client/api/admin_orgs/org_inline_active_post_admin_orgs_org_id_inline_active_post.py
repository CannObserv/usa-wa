...
from ...models.body_org_inline_active_post_admin_orgs_org_id_inline_active_post import (
...
def _get_kwargs(
    org_id: str,
    *,
    body: BodyOrgInlineActivePostAdminOrgsOrgIdInlineActivePost | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/admin/orgs/{org_id}/inline/active/".format(
