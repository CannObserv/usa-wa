...
from ..models.body_name_create_admin_orgs_entity_id_names_post_visibility_type_0 import (
    BodyNameCreateAdminOrgsEntityIdNamesPostVisibilityType0,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="BodyNameCreateAdminOrgsEntityIdNamesPost")


@_attrs_define
class BodyNameCreateAdminOrgsEntityIdNamesPost:
    """
    Attributes:
        name (str):
        name_type (str | Unset):  Default: 'legal'.
        is_canonical (str | Unset):  Default: ''.
        visibility (BodyNameCreateAdminOrgsEntityIdNamesPostVisibilityType0 | None | Unset):
    ...
    visibility: BodyNameCreateAdminOrgsEntityIdNamesPostVisibilityType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.visibility, Unset):
            visibility = UNSET
        elif isinstance(self.visibility, BodyNameCreateAdminOrgsEntityIdNamesPostVisibilityType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_visibility(data: object) -> BodyNameCreateAdminOrgsEntityIdNamesPostVisibilityType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                visibility_type_0 = BodyNameCreateAdminOrgsEntityIdNamesPostVisibilityType0(data)

                return visibility_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(BodyNameCreateAdminOrgsEntityIdNamesPostVisibilityType0 | None | Unset, data)
        ...
        body_name_create_admin_orgs_entity_id_names_post = cls(
            name=name,
            name_type=name_type,
        ...
        body_name_create_admin_orgs_entity_id_names_post.additional_properties = d
        return body_name_create_admin_orgs_entity_id_names_post
