...
from ..models.body_name_create_admin_people_entity_id_names_post_visibility_type_0 import (
    BodyNameCreateAdminPeopleEntityIdNamesPostVisibilityType0,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="BodyNameCreateAdminPeopleEntityIdNamesPost")


@_attrs_define
class BodyNameCreateAdminPeopleEntityIdNamesPost:
    """
    Attributes:
        name (str):
        name_type (str | Unset):  Default: 'legal'.
        is_canonical (str | Unset):  Default: ''.
        visibility (BodyNameCreateAdminPeopleEntityIdNamesPostVisibilityType0 | None | Unset):
    ...
    visibility: BodyNameCreateAdminPeopleEntityIdNamesPostVisibilityType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.visibility, Unset):
            visibility = UNSET
        elif isinstance(self.visibility, BodyNameCreateAdminPeopleEntityIdNamesPostVisibilityType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_visibility(data: object) -> BodyNameCreateAdminPeopleEntityIdNamesPostVisibilityType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                visibility_type_0 = BodyNameCreateAdminPeopleEntityIdNamesPostVisibilityType0(data)

                return visibility_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(BodyNameCreateAdminPeopleEntityIdNamesPostVisibilityType0 | None | Unset, data)
        ...
        body_name_create_admin_people_entity_id_names_post = cls(
            name=name,
            name_type=name_type,
        ...
        body_name_create_admin_people_entity_id_names_post.additional_properties = d
        return body_name_create_admin_people_entity_id_names_post
