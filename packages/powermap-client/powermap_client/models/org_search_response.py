...
if TYPE_CHECKING:
    from ..models.org_search_result import OrgSearchResult
    from ..models.search_meta import SearchMeta


T = TypeVar("T", bound="OrgSearchResponse")
...
class OrgSearchResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = OrgSearchResult.from_dict(data_item_data)

            data.append(data_item)

        meta = SearchMeta.from_dict(d.pop("meta"))

        org_search_response = cls(
            data=data,
            meta=meta,
        )

        org_search_response.additional_properties = d
        return org_search_response
