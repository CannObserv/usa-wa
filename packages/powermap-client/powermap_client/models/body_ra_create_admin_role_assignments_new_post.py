...
T = TypeVar("T", bound="BodyRaCreateAdminRoleAssignmentsNewPost")


@_attrs_define
class BodyRaCreateAdminRoleAssignmentsNewPost:
    """
    Attributes:
        person_id (str):
        role_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_ra_create_admin_role_assignments_new_post = cls(
            person_id=person_id,
            role_id=role_id,
        ...
        body_ra_create_admin_role_assignments_new_post.additional_properties = d
        return body_ra_create_admin_role_assignments_new_post
