...
T = TypeVar("T", bound="BodyEventEditRowPostAdminOrgsEntityIdEventsEventIdEditRowPost")


@_attrs_define
class BodyEventEditRowPostAdminOrgsEntityIdEventsEventIdEditRowPost:
    """
    Attributes:
        event_type_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_event_edit_row_post_admin_orgs_entity_id_events_event_id_edit_row_post = cls(
            event_type_id=event_type_id,
        ...
        body_event_edit_row_post_admin_orgs_entity_id_events_event_id_edit_row_post.additional_properties = d
        return body_event_edit_row_post_admin_orgs_entity_id_events_event_id_edit_row_post
