...
if TYPE_CHECKING:
    from ..models.jurisdiction_identifier import JurisdictionIdentifier
    from ..models.jurisdiction_type import JurisdictionType


T = TypeVar("T", bound="JurisdictionResponse")
...
class JurisdictionResponse:
    ...
    Attributes:
        ...
        slug (str):
        name (str):
        type_ (JurisdictionType): A jurisdiction type from the lookup table.
        ...
        identifiers (list[JurisdictionIdentifier] | Unset):
    """

    id: str
    slug: str
    name: str
    type_: JurisdictionType
    recorded_at: None | str
    created_at: None | str
    updated_at: None | str
    ...
    identifiers: list[JurisdictionIdentifier] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = JurisdictionType.from_dict(d.pop("type"))
        ...
        if _identifiers is not UNSET:
            ...
            for identifiers_item_data in _identifiers:
                identifiers_item = JurisdictionIdentifier.from_dict(identifiers_item_data)

                identifiers.append(identifiers_item)

        jurisdiction_response = cls(
            id=id,
            slug=slug,
            name=name,
            type_=type_,
        ...
        jurisdiction_response.additional_properties = d
