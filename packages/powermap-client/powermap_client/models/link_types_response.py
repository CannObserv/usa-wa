...
T = TypeVar("T", bound="LinkTypesResponse")


@_attrs_define
class LinkTypesResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = LinkType.from_dict(data_item_data)

            data.append(data_item)

        link_types_response = cls(
            data=data,
        )

        link_types_response.additional_properties = d
        return link_types_response
