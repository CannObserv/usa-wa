...
T = TypeVar("T", bound="JurisdictionListItem")


@_attrs_define
class JurisdictionListItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        jurisdiction_list_item.additional_properties = d
        return jurisdiction_list_item
