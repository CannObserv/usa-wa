...
T = TypeVar("T", bound="RoleContactMethod")


@_attrs_define
class RoleContactMethod:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        role_contact_method.additional_properties = d
        return role_contact_method
