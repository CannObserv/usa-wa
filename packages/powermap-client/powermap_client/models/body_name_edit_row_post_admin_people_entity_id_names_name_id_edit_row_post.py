...
from ..models.body_name_edit_row_post_admin_people_entity_id_names_name_id_edit_row_post_visibility_type_0 import (
    BodyNameEditRowPostAdminPeopleEntityIdNamesNameIdEditRowPostVisibilityType0,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="BodyNameEditRowPostAdminPeopleEntityIdNamesNameIdEditRowPost")


@_attrs_define
class BodyNameEditRowPostAdminPeopleEntityIdNamesNameIdEditRowPost:
    """
    Attributes:
        name (str):
        name_type (str | Unset):  Default: 'legal'.
        is_canonical (str | Unset):  Default: ''.
        visibility (BodyNameEditRowPostAdminPeopleEntityIdNamesNameIdEditRowPostVisibilityType0 | None | Unset):
    ...
    visibility: BodyNameEditRowPostAdminPeopleEntityIdNamesNameIdEditRowPostVisibilityType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.visibility, Unset):
            visibility = UNSET
        elif isinstance(self.visibility, BodyNameEditRowPostAdminPeopleEntityIdNamesNameIdEditRowPostVisibilityType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_visibility(
            data: object,
        ) -> BodyNameEditRowPostAdminPeopleEntityIdNamesNameIdEditRowPostVisibilityType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                visibility_type_0 = BodyNameEditRowPostAdminPeopleEntityIdNamesNameIdEditRowPostVisibilityType0(data)

                return visibility_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(
                BodyNameEditRowPostAdminPeopleEntityIdNamesNameIdEditRowPostVisibilityType0 | None | Unset, data
            )
        ...
        body_name_edit_row_post_admin_people_entity_id_names_name_id_edit_row_post = cls(
            name=name,
            name_type=name_type,
        ...
        body_name_edit_row_post_admin_people_entity_id_names_name_id_edit_row_post.additional_properties = d
        return body_name_edit_row_post_admin_people_entity_id_names_name_id_edit_row_post
