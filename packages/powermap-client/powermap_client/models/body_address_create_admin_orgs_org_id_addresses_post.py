...
T = TypeVar("T", bound="BodyAddressCreateAdminOrgsOrgIdAddressesPost")


@_attrs_define
class BodyAddressCreateAdminOrgsOrgIdAddressesPost:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_address_create_admin_orgs_org_id_addresses_post = cls(
        ...
        body_address_create_admin_orgs_org_id_addresses_post.additional_properties = d
        return body_address_create_admin_orgs_org_id_addresses_post
