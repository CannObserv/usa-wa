...
T = TypeVar("T", bound="BodyEventCreateAdminPeopleEntityIdEventsPost")


@_attrs_define
class BodyEventCreateAdminPeopleEntityIdEventsPost:
    """
    Attributes:
        event_type_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_event_create_admin_people_entity_id_events_post = cls(
            event_type_id=event_type_id,
        ...
        body_event_create_admin_people_entity_id_events_post.additional_properties = d
        return body_event_create_admin_people_entity_id_events_post
