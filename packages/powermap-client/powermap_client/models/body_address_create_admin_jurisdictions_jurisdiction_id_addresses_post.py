...
T = TypeVar("T", bound="BodyAddressCreateAdminJurisdictionsJurisdictionIdAddressesPost")


@_attrs_define
class BodyAddressCreateAdminJurisdictionsJurisdictionIdAddressesPost:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_address_create_admin_jurisdictions_jurisdiction_id_addresses_post = cls(
        ...
        body_address_create_admin_jurisdictions_jurisdiction_id_addresses_post.additional_properties = d
        return body_address_create_admin_jurisdictions_jurisdiction_id_addresses_post
