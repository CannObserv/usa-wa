...
T = TypeVar("T", bound="RoleTypesResponse")


@_attrs_define
class RoleTypesResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = RoleType.from_dict(data_item_data)

            data.append(data_item)

        role_types_response = cls(
            data=data,
        )

        role_types_response.additional_properties = d
