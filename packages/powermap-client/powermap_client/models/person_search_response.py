...
if TYPE_CHECKING:
    from ..models.person_search_result import PersonSearchResult
    from ..models.search_meta import SearchMeta


T = TypeVar("T", bound="PersonSearchResponse")
...
class PersonSearchResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = PersonSearchResult.from_dict(data_item_data)

            data.append(data_item)

        meta = SearchMeta.from_dict(d.pop("meta"))

        person_search_response = cls(
            data=data,
            meta=meta,
        )

        person_search_response.additional_properties = d
