...
T = TypeVar("T", bound="BodyAddressEditRowPostAdminOrgsOrgIdAddressesAddrIdEditRowPost")


@_attrs_define
class BodyAddressEditRowPostAdminOrgsOrgIdAddressesAddrIdEditRowPost:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_address_edit_row_post_admin_orgs_org_id_addresses_addr_id_edit_row_post = cls(
        ...
        body_address_edit_row_post_admin_orgs_org_id_addresses_addr_id_edit_row_post.additional_properties = d
        return body_address_edit_row_post_admin_orgs_org_id_addresses_addr_id_edit_row_post
