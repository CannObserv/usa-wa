...
position-less ``state_representative`` seat, which would be a false structural claim — PM's
``requires_qualifier`` refused the same shape; the genuine pre-1965 at-large seat is #230) —
